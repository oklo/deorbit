...
echo "== GPU gates =="
for m in sod sedov surface shear yield tensile freefall atmos pierazzo vacuum tracer af_activate sedov_axi lame af_visc vib_advect friction substrate; do
