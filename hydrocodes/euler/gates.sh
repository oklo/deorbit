...
CPU="sod shear yield vacuum tracer tensile freefall atmos alimpact pierazzo2d af_activate sedov_axi lame af_visc vib_advect friction substrate visc_diff visc_agree visc_energy vib_regen bingham_slope"
[ "$QUICK" = "quick" ] || CPU="sod sedov shear yield vacuum tracer tensile freefall atmos alimpact pierazzo2d af_activate sedov_axi lame af_visc vib_advect friction substrate visc_diff visc_agree visc_energy vib_regen bingham_slope"
echo "== CPU gates =="
