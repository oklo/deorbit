...
struct Material {
    ...
    // strength (stored now; used once the strength model lands)
    double G = 0, Y = 0;
    ...
    static Material basalt() { return tillotson(2700, 2.67e10, 2.67e10, 0.5, 1.5, 5, 5,
                                                4.87e8, 4.72e6, 1.82e7, 2.27e10, 3.5e8); }
